---
name: ga-audit
description: Run a GA4 CRO Funnel Analysis for a client. Full funnel visualization, per-channel/device/resolution breakdowns, cross-referenced recommendations with wireframes and dollar impact estimates.
---
