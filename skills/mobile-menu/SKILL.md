---
name: mobile-menu
description: Build a CRO-optimized mobile menu drawer.
---
...
- `/Users/eapple/tongue-tang-theme/snippets/tt-mobile-nav.liquid` — best sellers carousel, emoji icons, USP badges, pink drip footer, AJAX ATC
- `/Users/eapple/tongue-tang-theme/sections/mb_nav.liquid` — how the snippet is injected into Kalles mobile nav (line 321) with `tt_bestsellers_collection` setting
- Rename `tt-` prefix, replace TT-branded copy (emojis, badge text, tagline), adapt for client's theme
