---
name: hero-section
description: Build a CRO-optimized homepage hero section.
---
...
When asked to use the TT/draft theme template, this proven reference is available:
- `/Users/eapple/tongue-tang-theme/sections/tt-homepage-hero.liquid`
- Features: separate desktop/mobile background images, star rating badge with backdrop blur, configurable overlay, trust bar, all colors/sizes via schema
- Rename `tt-` prefix to client prefix, adapt brand colors/copy
